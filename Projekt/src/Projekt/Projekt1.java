...
import java.awt.event.*;
	...
	public class Projekt1 extends Frame implements Runnable {
	...
	public void paint (Graphics g){
		if(bildschirmmodus==0){
			...
			g.drawString("Spiel am besten zuerst Level 1 !!!", 150, 280);
			g.drawString("Für Fragen lies die Anleitung.", 150, 320);
			Font arial = new Font("Arial",Font.BOLD,20);
			g.setFont(arial);
			g.drawString("Space War", 180, 100);
		}
		if(bildschirmmodus==1){
		remove(b1);
		remove(b2);
	...
	g.drawImage(Laserskal3, xg,yg,this);
		...
		if(bildschirmmodus==2){
			...
			Font arial2 = new Font("Arial",Font.PLAIN,12);
			g.setFont(arial2);
			g.drawString("Ein Spiel von:", 100, 450);
			g.drawString("Du musst dich noch verbessern...", 150, 300);
			...
			Font arial = new Font("Arial",Font.BOLD,20);
			g.setFont(arial);
			g.drawString("Marco Müller",100,480);
			...
			g.drawString("Game Over...",100,90);}
				...
				Font arial = new Font("Arial",Font.BOLD,20);
				g.setFont(arial);
				g.drawString("Der Feind siegt...",160,460);
			}
		...
		if(bildschirmmodus==3){
			...
			g.drawString("Sobald ein Laser berührt wird, ist das Spiel zu Ende.", 150, 330);
			Font arial = new Font("Arial",Font.BOLD,20);
			g.setFont(arial);
		...
		if(bildschirmmodus==10){
			...
			Font arial = new Font("Arial",Font.BOLD,20);
			g.setFont(arial);
			g.drawString("Du bist ein guter Pilot!",100,100);
			Font arial2 = new Font("Arial",Font.PLAIN,12);
			g.setFont(arial2);
